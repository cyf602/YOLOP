...
# Set a specific color for each class
...
assert len(colors) == len(names), 'specify colors for all classes'
...
def detect(cfg,opt):
    ...
    # these lines are required; otherwise pytorch cannot find CUDA device for some reason
    ...
    # Uncomment these two lines if you need class names from the model and random colors for the bounding boxes
